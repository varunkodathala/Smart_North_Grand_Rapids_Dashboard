...
def login():
    ...
    if st.session_state["authentication_status"]:
        ...
        st.subheader(f'Welcome *{st.session_state["name"]}*', anchor=None)        
        ...
        def send_email(user,email,data, dates, vehicle_category):
            ...
            sender_address = 'vizworldsmartnorth@gmail.com'
            sender_pass = 'mkvvmhkpkzmelgzn'
